...
import { ImageCardsListComponent } from '../../schedulers/components/image-cards-list/image-cards-list.component';
  ...
  fetchAvailableScreens(): void {
    ...
    if (formattedStartDate && formattedEndDate) {
      this.schedulerService
        .getAvailableScreens(formattedStartDate, formattedEndDate)
        .subscribe(
          (data: any) => {
          ...
          (error) => {
            ...
            this.notificationService.showNotification(
              'Error fetching available screens',
              'error'
            );
          }
        );
